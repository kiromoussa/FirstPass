    ...
    <div className="flex items-center gap-4">
      <div className="relative w-[86px] h-[86px]">
        <svg viewBox="0 0 80 80" className="w-full h-full -rotate-90">
          <circle cx="40" cy="40" r={r} fill="none" stroke="#edefe9" strokeWidth="8" />
          <circle
            cx="40"
            cy="40"
            r={r}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-[9px] text-muted -mt-1">/ 100</span>
        </div>
      </div>
      <div>
        <div className="font-mono text-[10px] uppercase tracking-widest text-muted">Permit readiness</div>
