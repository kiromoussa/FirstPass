        ...
        <div className="flex items-center gap-3.5">
          ...
          <Show when="signed-out">
            <SignInButton mode="modal">
              <button className="text-[14.5px] font-semibold text-ink hover:text-teal transition-colors">
                Sign in
              </button>
            </SignInButton>
            <SignUpButton mode="modal">
              <button className="text-[14.5px] font-semibold text-white bg-teal rounded-[10px] px-[17px] py-2.5 hover:bg-teal-600 transition-colors">
                Try it free
              </button>
            </SignUpButton>
          </Show>
